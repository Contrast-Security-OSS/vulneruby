...
Gem::Specification.new do |spec|
  ...
  spec.email         = ['donald.propst@contrastsecurity.com', 'ruby@contrastsecurity.com']

  spec.summary       = %q{Used in the Contrast Security vulnerable ruby applications to share common functionality across ruby projects}
